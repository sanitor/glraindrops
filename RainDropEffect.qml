...
ShaderEffect {
    ...
    property vector3d iResolution: Qt.vector3d(1280, 720, 1)
    property vector3d iMouse: Qt.vector3d(960, 360, 0.5)
    ...
    fragmentShader: "
        ...
        void main()
        {
            vec2 uv = (qt_TexCoord0.xy-.5*iResolution.xy) / iResolution.y;
            vec2 UV = qt_TexCoord0.xy/iResolution.xy;
            ...
            vec3 col = texture2D(source, UV + n).rgb; //textureLod(iChannel0, UV+n, focus).rgb;
